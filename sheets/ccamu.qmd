...
- ajouter sa clef SSH via l'interface avec le bouton "upload ssh key", voir la doc [Générer une clef ssh](sheets/clef_ssh.html): donner le fichier .ssh/id_xxxx.pub
